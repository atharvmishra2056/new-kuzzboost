...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero overflow-hidden pt-20">
...
// Helper function to map service title to FAQ type
function getServiceType(serviceTitle: string): string {
  const serviceMap: Record<string, string> = {
    'instagram': 'instagram-followers',
    'youtube': 'youtube-views',
    'spotify': 'spotify-playlist',
